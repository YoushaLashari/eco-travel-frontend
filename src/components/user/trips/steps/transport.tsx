...
export default function TripTransport({handleData, trip, error}: TripNameProps){
    let transport = trip.transport === "flight" ? "✈️ Avion" : trip.transport === "train" ? "🚆 Train" : trip.transport === "car" ? "🚗 Voiture" : "🚌 Bus";
    return(
        <div>
            ...
            <div className="mx-auto w-full mt-5">
                <Select onValueChange={(value) => handleData("transport", value)}>
