        ...
        <div>
            ...
            <div className="mt-5">
                ...
                <div className="flex place-content-around mt-2">
                    ...
                    <p className="text-left w-full"><strong>{startDate.toLocaleDateString('fr-FR')}</strong></p>
                </div>
                <div className="flex place-content-around mt-2">
                    <p className="text-left w-full">Date de fin:</p>
                    <p className="text-left w-full"><strong>{endDate?.toLocaleDateString('fr-FR')}</strong></p>
                </div>
                <div className="flex place-content-around mt-2">
